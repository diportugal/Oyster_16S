...
#sample_data(physeq_class18)$RFTM.asfactor18 = sample_data(physeq_class18)$RFTM_score.x = as.factor(sample_data(physeq_class18)$RFTM_score.x)

#sample_data(physeq_class18)$Weight=as.factor(sample_data(physeq_class18)$Weight)

#sample_data(physeq_class18)$RFTM.asnum18 = sample_data(physeq_class18)$RFTM.asnum18 = as.numeric(sample_data(physeq_class18)$RFTM_score.x)
